        ...
        <div class="md:w-1/2 p-10 bg-white rounded-lg shadow-xl mt-10 md:mt-0">
            <form action="{{ route('posts.store') }}" method="POST" novalidate>
                ...
                <div class="mb-5">
                    ...
                    <input type="text" id="title" name="title" placeholder="Nombre de la publicación" class="border p-3 w-full rounded-lg @error('title') 
                        border-red-500
                ...
                <div class="mb-5">
                    ...
                    <textarea id="description" name="description" placeholder="Descripción de la publicación" class="border p-3 w-full rounded-lg @error('description') 
                        border-red-500
